...
//TTree *TSim; // tree for simulated data
...
void plotR(Int_t runno, /*Int_t simRunNo,*/ Int_t n_events=-1){
  ...
  //TString simFile;
  //simFile.Form("/home/llorenti/CDetOptical/data/AnaBarMC_%d.root",simRunNo)
...
/////////////////  L.L. Project (or not)  //////////////////////////////////
	...
	// need to think about what the parameters should be
//TCanvas *plot_adc_sim(Float_t Theta_min_cut = 0.0, Float_t Photon_Threshold = 8.0, Float_t Edep_Threshold = 1.0){

//TH1D *hPaddlePMTNphot[NUMPADDLE];
//TH1D *hPaddlePMTNoiseCutNphot[NUMPADDLE];
...
TCanvas *plot_adc_fit(Int_t pmt=1, Int_t tdc_min=900, Int_t tdc_width=50, Int_t adc_neighbor_cut=10, Int_t adc_cut=50, Int_t max=800){
...
TCanvas *plot_tdc(Int_t pmt=1, Int_t adc_cut=40, Int_t tdc_min=750, Int_t tdc_width=300){
	...
	TCanvas *cTDC1 = new TCanvas("cTDC1", "TDC one pixel", xcanvas, ycanvas);
